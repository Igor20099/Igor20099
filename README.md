...
<ul>
  <li>Мне нравится верстать статический сайты на HTML и CSS, а также доабвлять динамику на страницу с помощью Javascript(TypeScript). Нравится создавать с помощью библиотеки React динамические веб-сайты и веб-приложения. Также увлекаюсь созданием игр с помощью фреймворка Phaser.js с использованием языка JavaScript(TypeScript) и на игровом движке Defold с использованием языка Lua</li>
</ul>
<h2></h2>
