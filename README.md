<h1 align="center">Добро пожаловать на мою страницу<img src="https://github.com/blackcater/blackcater/raw/main/images/Hi.gif" height="32"/></h1>
...
<p>Я Frontend Developer и Game Developer</p>
<ul>
  <li>Верстаю статические сайты на HTML,CSS(SCSS) и добавляю динамику страницам с помощью JavaScript(TypeScript) 
  <li>Создаю SPA с помощью React и Vue </li>
  <li>Создаю 2D игры на игровом движке Defold с пмощью языка Lua, а так же делаю игры на фреймворке Phaser.js на JavaScript(TypeScript)</li>
