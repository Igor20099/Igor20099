...
<ul>
  <li>Мне нравится верстать статический сайты на HTML и CSS, а также доабвлять динамику на страницу с помощью Javascript(TypeScript)
  <li>Нравится создавать с помощью библиотеки React динамические веб-сайты и веб-приложения</li>
